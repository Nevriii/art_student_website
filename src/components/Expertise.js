    ...
    <section className="section3 color1" id='expertise'>
      <div className="container">
        <div className="container-fluid">
          {/* Mobile layout - controlled by CSS media queries */}
          <div className="mobile-expertise-layout">
            <div className="row">
              <div className="col-12 text-center mb-4">
                <h1 className="fontcolor2 font-weight-bolder font1 expertiseloc mobile-expertise-title" data-aos="zoom-out-left" data-aos-duration="2000">
                  EXPERTISE
                </h1>
              </div>
            </div>
            <div className="row mobile-expertise-grid">
              <div className="col-6 mobile-expertise-item">
                <img 
                  src={powerImage} 
                  className="rounded img-fluid mobile-expertise-image" 
                  alt="Power" 
                  data-aos="flip-left" 
              ...
              {/* Empty cell to complete the 4x2 grid */}
              <div className="col-6 mobile-expertise-item">
                {/* You can add another image here or leave empty */}
              </div>
            </div>
          </div>

          {/* Desktop layout - controlled by CSS media queries */}
          <div className="desktop-expertise-layout">
            <div className="row">
